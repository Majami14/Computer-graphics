...
Texture::LoadImageToTexture(const std::string& filePath) {
    ...
    // NOTE: Images should usually flipped vertically as they are loaded "upside-down"
    stbi__vertical_flip(ImageData, TextureWidth, TextureHeight, TextureChannels);

    // NOTE: Checks or "guesses" the loaded image's format
    ...
    // NOTE: ImageData is no longer necessary in RAM and can be deallocated
